 ...
 * Date: 2021-01-20
 * Time: 10:08:11 AM
 * Filename: appReportPurchase.js
 */
$(function () {
    var slug = "appReportPurchase",
    ...
    root.find("#iform-appReportPurchase").on("prevent-post",function(e,data){
        var table = root.find("#icms-table-appReportPurchase");
    ...
    root.find("#iform-appReportPurchase").on("resetted",function(e){
        root.find("#icms-table-appReportPurchase").data("extra-param","").find(".report-download").hide();
        nativeTable(slug, false,true);
    });

    root.find("#icms-table-appReportPurchase").on("table_search_enter",function(e,data){
        if(data.data!==null){
